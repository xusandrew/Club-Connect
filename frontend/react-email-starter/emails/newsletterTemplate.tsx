...
const NewsletterEmail = ({ events }: NewsletterProps) => {
  const eventsThisWeek = events.map((event: Event) => (
    <ul key={event.eid}>
      <Section style={body}>
...
NewsletterEmail.PreviewProps = {
  events: [
    ...
    {
      title: 'Intro to Coding Workshop 2',
      description: 'Learn the basics of coding with Python 2',
      start_time: new Date(),
      end_time: new Date(),
      location: 'Tech Lab 2',
      club: {
