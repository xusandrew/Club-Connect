...
export function RabbitIcon({ width = 24, height = 24, ...props }: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      {...props}
      xmlns='http://www.w3.org/2000/svg'
...
export function GameControllerIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg {...props} viewBox='0 0 512 512' fill='currentColor' height='1em' width='1em'>
      <path
        fill='none'
        stroke='currentColor'
        strokeMiterlimit={10}
...
export function IconGlobalLine(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox='0 0 24 24' fill='currentColor' height='1em' width='1em' {...props}>
...
export function ColouredInstagram(props: React.SVGProps<SVGSVGElement>) {
  return (
...
export function Group(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      width='24'
